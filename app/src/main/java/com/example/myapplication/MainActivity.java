...
public class MainActivity extends AppCompatActivity {
    ...
    public void drawSomething(View view) {
        ...
        if (mOffset == OFFSET) {
            ...
            mPaint.setColor(mColorAccent - MULTIPLIER * mOffset);
            mCanvas.drawCircle(630, 1237, halfWidth/25, mPaint);
            mOffset += OFFSET;
        } else {
            Point a = new Point(halfWidth - 400, halfHeight - 165);
            Point b = new Point(halfWidth + 400, halfHeight - 165);
            Point c = new Point(halfWidth, halfHeight - 665);
